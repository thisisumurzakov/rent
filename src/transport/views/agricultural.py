...
from ..models import Agricultural
from ..serializer import AgriculturalSerializer, AgriculturalAddSerializer
from main.serializers.product_serializer import ProductAddSerializer


class AgriculturalGetView(APIView):
    permission_classes = (AllowAny,)

    def get(self, request, *args, **kwargs):
        obj = get_object_or_404(Agricultural.objects.select_related("product"),
                                product__slug=kwargs["slug"], product__draft=False)
        data = AgriculturalSerializer(obj).data
